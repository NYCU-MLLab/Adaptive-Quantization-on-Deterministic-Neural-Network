...
class _ConvNd(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 padding, dilation, output_padding, groups, p_logvar_init=-1., p_pi=1.0, q_logvar_init=-2.):
...
class BBBLinearFactorial(nn.Module):
    ...
    in the layer.
    """
    def __init__(self, in_features, out_features, p_logvar_init=-1., p_pi=1, q_logvar_init=-2.):
    ...
    def fcquantizedforward(self, input):
        weights = self.qw.sample()
        return output
